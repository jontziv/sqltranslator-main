...
class TestToolMemoryModel:
    ...
    def test_tool_memory_import(self):
        ...
        from sqltranslator.capabilities.agent_memory import ToolMemory
...
class TestToolMemorySearchResultModel:
    ...
    def test_memory_search_result_import(self):
        ...
        from sqltranslator.capabilities.agent_memory import ToolMemorySearchResult
    ...
    def test_memory_search_result_instantiation(self):
        ...
        from sqltranslator.capabilities.agent_memory import ToolMemorySearchResult, ToolMemory
...
class TestTextMemoryModel:
    ...
    def test_text_memory_import(self):
        ...
        from sqltranslator.capabilities.agent_memory import TextMemory
...
class TestTextMemorySearchResultModel:
    ...
    def test_text_memory_search_result_import(self):
        ...
        from sqltranslator.capabilities.agent_memory import TextMemorySearchResult
    ...
    def test_text_memory_search_result_instantiation(self):
        ...
        from sqltranslator.capabilities.agent_memory import TextMemorySearchResult, TextMemory
...
class TestChromaDBAgentMemory:
    ...
    def test_chromadb_import(self):
        ...
        try:
            from sqltranslator.integrations.chromadb import ChromaAgentMemory
...
class TestQdrantAgentMemory:
    ...
    def test_qdrant_import(self):
        ...
        try:
            from sqltranslator.integrations.qdrant import QdrantAgentMemory
...
class TestPineconeAgentMemory:
    ...
    def test_pinecone_import(self):
        ...
        try:
            from sqltranslator.integrations.pinecone import PineconeAgentMemory
...
class TestMilvusAgentMemory:
    ...
    def test_milvus_import(self):
        ...
        try:
            from sqltranslator.integrations.milvus import MilvusAgentMemory
...
class TestWeaviateAgentMemory:
    ...
    def test_weaviate_import(self):
        ...
        try:
            from sqltranslator.integrations.weaviate import WeaviateAgentMemory
...
class TestFAISSAgentMemory:
    ...
    def test_faiss_import(self):
        ...
        try:
            from sqltranslator.integrations.faiss import FAISSAgentMemory
...
class TestOpenSearchAgentMemory:
    ...
    def test_opensearch_import(self):
        ...
        try:
            from sqltranslator.integrations.opensearch import OpenSearchAgentMemory
...
class TestAzureAISearchAgentMemory:
    ...
    def test_azuresearch_import(self):
        ...
        try:
            from sqltranslator.integrations.azuresearch import AzureAISearchAgentMemory
...
class TestMarqoAgentMemory:
    ...
    def test_marqo_import(self):
        ...
        try:
            from sqltranslator.integrations.marqo import MarqoAgentMemory
...
class TestDemoAgentMemory:
    ...
    def test_demo_import(self):
        ...
        from sqltranslator.integrations.local.agent_memory import DemoAgentMemory
