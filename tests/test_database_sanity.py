...
class TestSqlRunnerInterface:
    ...
    def test_sql_runner_import(self):
        ...
        from sqltranslator.capabilities.sql_runner import SqlRunner
...
class TestRunSqlToolArgsModel:
    ...
    def test_run_sql_tool_args_import(self):
        ...
        from sqltranslator.capabilities.sql_runner import RunSqlToolArgs
...
class TestPostgresRunner:
    ...
    def test_postgres_runner_import(self):
        ...
        from sqltranslator.integrations.postgres import PostgresRunner
...
class TestLegacySqlRunner:
    ...
    def test_legacy_sql_runner_import(self):
        ...
        from sqltranslator.legacy.adapter import LegacySqlRunner
...
class TestDatabaseIntegrationModules:
    ...
    def test_postgres_module_import(self):
        ...
        try:
            import sqltranslator.integrations.postgres

            assert sqltranslator.integrations.postgres is not None
        except ImportError as e:
    ...
    def test_sqlite_module_import(self):
        ...
        try:
            import sqltranslator.integrations.sqlite

            assert sqltranslator.integrations.sqlite is not None
        except ImportError as e:
...
class TestLegacyVannaBaseConnections:
    ...
    def test_vanna_base_import(self):
        ...
        from sqltranslator.legacy.base.base import VannaBase
...
class TestLegacyVannaAdapter:
    ...
    def test_legacy_vanna_adapter_import(self):
        ...
        from sqltranslator.legacy.adapter import LegacyVannaAdapter
...
class TestSnowflakeRunner:
    ...
    def test_snowflake_runner_import(self):
        ...
        from sqltranslator.integrations.snowflake import SnowflakeRunner
...
class TestMySQLRunner:
    ...
    def test_mysql_runner_import(self):
        ...
        from sqltranslator.integrations.mysql import MySQLRunner
...
class TestClickHouseRunner:
    ...
    def test_clickhouse_runner_import(self):
        ...
        from sqltranslator.integrations.clickhouse import ClickHouseRunner
...
class TestOracleRunner:
    ...
    def test_oracle_runner_import(self):
        ...
        from sqltranslator.integrations.oracle import OracleRunner
...
class TestBigQueryRunner:
    ...
    def test_bigquery_runner_import(self):
        ...
        from sqltranslator.integrations.bigquery import BigQueryRunner
...
class TestDuckDBRunner:
    ...
    def test_duckdb_runner_import(self):
        ...
        from sqltranslator.integrations.duckdb import DuckDBRunner
...
class TestMSSQLRunner:
    ...
    def test_mssql_runner_import(self):
        ...
        from sqltranslator.integrations.mssql import MSSQLRunner
...
class TestPrestoRunner:
    ...
    def test_presto_runner_import(self):
        ...
        from sqltranslator.integrations.presto import PrestoRunner
...
class TestHiveRunner:
    ...
    def test_hive_runner_import(self):
        ...
        from sqltranslator.integrations.hive import HiveRunner
