"""
Simple end-to-end tests for SQLTranslator agents.
...
async def test_anthropic_top_artist(chinook_db):
    ...
    from sqltranslator.integrations.anthropic import AnthropicLlmService
...
async def test_openai_top_artist(chinook_db):
    ...
    from sqltranslator.integrations.openai import OpenAILlmService
...
async def test_azure_openai_top_artist(chinook_db):
    ...
    from sqltranslator.integrations.azureopenai import AzureOpenAILlmService
...
#     from sqltranslator.integrations.openai import OpenAIResponsesService
...
async def test_ollama_top_artist(chinook_db):
    ...
    from sqltranslator.integrations.ollama import OllamaLlmService
...
async def test_gemini_top_artist(chinook_db):
    ...
    from sqltranslator.integrations.google import GeminiLlmService
