...
from sqltranslator.core.workflow.default import DefaultWorkflowHandler
...
from sqltranslator.core.storage import Conversation
from sqltranslator.core.tool import ToolContext
from sqltranslator.capabilities.agent_memory import ToolMemory, TextMemory
from sqltranslator.integrations.local.agent_memory import DemoAgentMemory
from sqltranslator.core.rich_component import ComponentType
...
class TestStarterUI:
    ...
    async def test_starter_ui_user_view(
        ...
        assert "Welcome to SQLTranslator" in rich_text.content
