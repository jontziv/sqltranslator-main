...
from sqltranslator.integrations.azureopenai.llm import _is_reasoning_model
...
class TestAzureOpenAILlmServiceInitialization:
    ...
    @patch("sqltranslator.integrations.azureopenai.llm.AzureOpenAI")
...
class TestAzureOpenAILlmServicePayloadBuilding:
    ...
    def test_build_payload_includes_temperature_for_standard_model(
        ...
        from sqltranslator.core.llm import LlmRequest, LlmMessage
    ...
    def test_build_payload_with_tools(self, mock_azure_openai):
        ...
        from sqltranslator.core.llm import LlmRequest, LlmMessage
        from sqltranslator.core.user import User
        from sqltranslator.core.tool import ToolSchema
...
class TestImportError:
    ...
    def test_import_error_message(self):
        ...
        with patch.dict("sys.modules", {"openai": None}):
            ...
            if "sqltranslator.integrations.azureopenai.llm" in sys.modules:
                del sys.modules["sqltranslator.integrations.azureopenai.llm"]

            with pytest.raises(
                ImportError, match="pip install 'sqltranslator\\[azureopenai\\]'"
            ):
                from sqltranslator.integrations.azureopenai import AzureOpenAILlmService
