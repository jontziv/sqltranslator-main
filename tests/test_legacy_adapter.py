...
class SimpleUserResolver(UserResolver):
    ...
    async def resolve_user(self, request_context: RequestContext) -> User:
        user_email = request_context.cookies.get("sqltranslator_email", "test@example.com")
...
async def test_legacy_adapter_with_anthropic():
    ...
    from sqltranslator.legacy.mock import MockLLM
    from sqltranslator.legacy.chromadb import ChromaDB_VectorStore
