...
Usage:
    python -m sqltranslator.examples.mock_auth_example
"""
...
from sqltranslator import AgentConfig, Agent
from sqltranslator.core.registry import ToolRegistry
from sqltranslator.core.llm import LlmRequest, LlmResponse
from sqltranslator.core.middleware import LlmMiddleware
from sqltranslator.integrations.mock import MockLlmService
from sqltranslator.core.user import CookieEmailUserResolver, RequestContext
...
def create_demo_agent() -> Agent:
    ...
    user_resolver = CookieEmailUserResolver(cookie_name="sqltranslator_email")
...
async def demo_authentication():
    ...
    request_context = RequestContext(
        cookies={"sqltranslator_email": "alice@example.com"},
        headers={},
    ...
    bob_context = RequestContext(
        cookies={"sqltranslator_email": "bob@company.com"},
    ...
    print("• CookieEmailUserResolver extracts email from sqltranslator_email cookie")
