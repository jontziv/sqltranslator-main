...
Run:
  PYTHONPATH=. python sqltranslator/examples/anthropic_quickstart.py
"""
...
async def main() -> None:
    ...
    from sqltranslator import AgentConfig, Agent, User
    from sqltranslator.core.registry import ToolRegistry
    from sqltranslator.tools import ListFilesTool
