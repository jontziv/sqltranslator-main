...
Usage:
    PYTHONPATH=. python sqltranslator/examples/evaluation_example.py
"""

import asyncio
from sqltranslator import Agent, MockLlmService, MemoryConversationStore, User
from sqltranslator.core.evaluation import (
    EvaluationRunner,
    EvaluationDataset,
    TestCase,
    ExpectedOutcome,
...
async def main():
    ...
    print("\n🚀 SQLTranslator Evaluation System Demo")
    print("=" * 80)
    ...
    print("=" * 80)
    print("\nKey Takeaways:")
    print("  1. Evaluations are integral to the SQLTranslator package")
