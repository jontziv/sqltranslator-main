...
Usage:
  python -m sqltranslator.examples.custom_system_prompt_example
"""

from typing import List, Optional

from sqltranslator.core.interfaces import SystemPromptBuilder
from sqltranslator.core.models import ToolSchema, User
...
async def demo() -> None:
    ...
    from sqltranslator import Agent, User
