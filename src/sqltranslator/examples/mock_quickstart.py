"""
Mock quickstart example for the SQLTranslator framework.
...
Usage:
  ...
  Interactive: python -m sqltranslator.examples.mock_quickstart
  REPL: from sqltranslator.examples.mock_quickstart import create_demo_agent
  Server: python -m sqltranslator.servers --example mock_quickstart
"""
...
def create_demo_agent() -> Agent:
    ...
    llm_service = MockLlmService(
        response_content="Hello! I'm a helpful AI assistant created using the SQLTranslator framework."
    )
...
def run_interactive() -> None:
    ...
    print("Starting SQLTranslator mock quickstart demo...")
    asyncio.run(main())
