...
Usage:
  PYTHONPATH=. python sqltranslator/examples/claude_sqlite_example.py
"""
...
if TYPE_CHECKING:
    from sqltranslator import Agent
...
async def main() -> None:
    ...
    from sqltranslator.tools import (
        RunSqlTool,
        VisualizeDataTool,
        LocalFileSystem,
    )
...
def create_demo_agent() -> "Agent":
    ...
    This function is called by the sqltranslator server framework.
    ...
    from sqltranslator import AgentConfig, Agent
    from sqltranslator.core.registry import ToolRegistry
    from sqltranslator.core.user import CookieEmailUserResolver
    from sqltranslator.integrations.sqlite import SqliteRunner
    from sqltranslator.tools import (
        RunSqlTool,
        VisualizeDataTool,
