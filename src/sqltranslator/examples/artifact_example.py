#!/usr/bin/env python3
"""
Example demonstrating the artifact system in SQLTranslator.
...
from sqltranslator import Agent, UiComponent, User, AgentConfig
from sqltranslator.core.rich_components import ArtifactComponent
from sqltranslator.integrations.anthropic.mock import MockLlmService
from sqltranslator.core.interfaces import Agent, LlmService
...
async def main() -> None:
    ...
    document.querySelector('sqltranslator-chat').addEventListener('artifact-opened', (event) => {
