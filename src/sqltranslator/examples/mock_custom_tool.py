...
Usage:
  ...
  Interactive: python -m sqltranslator.examples.mock_custom_tool
  REPL: from sqltranslator.examples.mock_custom_tool import create_demo_agent
  Server: python -m sqltranslator.servers --example mock_custom_tool
"""
