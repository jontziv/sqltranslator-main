"""
Email authentication example for the SQLTranslator framework.
...
Interactive: python -m sqltranslator.examples.email_auth_example
...
from sqltranslator.core import Tool, UserService
from sqltranslator.core import ToolContext, ToolResult
from sqltranslator.core.registry import ToolRegistry
from sqltranslator.core.components import UiComponent
from sqltranslator.core import RichComponent
