"""
ChromaDB integration for SQLTranslator.
"""
...
def create_sentence_transformer_embedding_function(
    ...
    Examples:
        ...
        >>> from sqltranslator.integrations.chromadb import ChromaAgentMemory, create_sentence_transformer_embedding_function
