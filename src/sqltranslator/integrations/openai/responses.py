...
from sqltranslator.core.llm import LlmService, LlmRequest, LlmResponse, LlmStreamChunk
...
class OpenAIResponsesService(LlmService):
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "openai package is required. Install with: pip install 'sqltranslator[openai]'"
            ) from e
