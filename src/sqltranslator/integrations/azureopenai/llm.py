...
from sqltranslator.core.llm import (
    LlmService,
    LlmRequest,
    LlmResponse,
    LlmStreamChunk,
)
from sqltranslator.core.tool import ToolCall, ToolSchema
...
class AzureOpenAILlmService(LlmService):
    ...
    Wraps `openai.AzureOpenAI` so SQLTranslator can talk to deployment-scoped models
    ...
    def __init__(
        ...
        **extra_client_kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "openai package is required. Install with: pip install 'sqltranslator[azureopenai]' "
