...
class PlotlyChartGenerator:
    ...
    # SQLTranslator brand colors from landing page
    THEME_COLORS = {
        "navy": "#023d60",
        "cream": "#e7e1cf",
        "teal": "#15a8a8",
    ...
    def _apply_standard_layout(self, fig: go.Figure) -> go.Figure:
        """Apply consistent SQLTranslator brand styling to all charts.

        Uses SQLTranslator brand colors from the landing page for a cohesive look.

        Args:
            fig: Plotly figure to update

        Returns:
            Updated figure with SQLTranslator brand styling
        """
        fig.update_layout(
            # paper_bgcolor='white',
            # plot_bgcolor='white',
            ...
            colorway=self.COLOR_PALETTE,  # Use SQLTranslator brand colors for data
    ...
    def _create_correlation_heatmap(
        ...
        # Custom SQLTranslator color scale: navy (negative) -> cream (neutral) -> teal (positive)
        vanna_colorscale = [
