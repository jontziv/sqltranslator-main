"""
Web components for SQLTranslator.

This module provides web components built with Lit that can be embedded
in web applications to provide rich UI for SQLTranslator agent interactions.
"""
...
<body>
    <sqltranslator-chat title="SQLTranslator Assistant"></sqltranslator-chat>
