...
def validate_pydantic_models_in_package(package_name: str) -> Dict[str, Any]:
    ...
    Args:
        package_name: Name of the package to validate (e.g., 'sqltranslator.core')
...
def check_models_health() -> bool:
    ...
    """
    core_packages = [
        "sqltranslator.core.tool.models",
        "sqltranslator.core.user.models",
        "sqltranslator.core.llm.models",
        "sqltranslator.core.storage.models",
        "sqltranslator.core.agent.models",
    ]
