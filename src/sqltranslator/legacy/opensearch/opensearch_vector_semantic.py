...
class OpenSearch_Semantic_VectorStore(VannaBase):
    def __init__(self, config=None):
        ...
        self.document_index = config.get("es_document_index", "sqltranslator_document_index")
        self.ddl_index = config.get("es_ddl_index", "sqltranslator_ddl_index")
        self.question_sql_index = config.get(
            "es_question_sql_index", "sqltranslator_questions_sql_index"
        )
