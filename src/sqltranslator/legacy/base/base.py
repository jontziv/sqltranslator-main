...
class VannaBase(ABC):
    ...
    def generate_followup_questions(
        ...
        **Example:**
        ...
        Generate a list of followup questions that you can ask SQLTranslator.
        ...
        Returns:
            list: A list of followup questions that you can ask SQLTranslator.
        """
    ...
    def generate_questions(self, **kwargs) -> List[str]:
        ...
        **Example:**
        ...
        Generate a list of questions that you can ask SQLTranslator.
        """
        ...
        **kwargs,
        ...
        try:
            ...
            raise DependencyError(
                ...
                " \npip install sqltranslator[snowflake]"
            )
        ...
        **Example:**
        ...
        try:
            ...
            raise DependencyError(
                ...
                " run command: \npip install sqltranslator[postgres]"
            )
    ...
    def connect_to_bigquery(
        ...
        **Example:**
        ...
        try:
            ...
            raise DependencyError(
                "You need to install required dependencies to execute this method, run command:"
                " \npip install sqltranslator[bigquery]"
            )
    ...
    def connect_to_duckdb(self, url: str, init_sql: str = None, **kwargs):
        ...
        try:
            ...
            raise DependencyError(
                "You need to install required dependencies to execute this method,"
                " run command: \npip install sqltranslator[duckdb]"
            )
        # URL of the database to download
    ...
    def ask(
        ...
        **Example:**
        ...
        Ask SQLTranslator a question and get the SQL query that answers it.

        Args:
            question (str): The question to ask.
            print_results (bool): Whether to print the results of the SQL query.
            auto_train (bool): Whether to automatically train SQLTranslator on the question and SQL query.
    ...
    def train(
        ...
        **Example:**
        ...
        Train SQLTranslator on a question and its corresponding SQL query.
