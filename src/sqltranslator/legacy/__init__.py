...
api_key: Union[str, None] = None  # API key for SQLTranslator
...
Set the SQL to DataFrame function for SQLTranslator. This is used in the [`vn.ask(...)`][sqltranslator.ask] function.
Instead of setting this directly you can also use [`vn.connect_to_snowflake(...)`][sqltranslator.connect_to_snowflake] to set this.

"""

__org: Union[str, None] = None  # Organization name for SQLTranslator
...
def error_deprecation():
    raise Exception("""
Please switch to the following method for initializing SQLTranslator:

from sqltranslator.remote import VannaDefault
...
def get_api_key(email: str, otp_code: Union[str, None] = None) -> str:
    ...
    **Example:**
    ...
    Login to the SQLTranslator API.
    ...
    Returns:
        str: The API key.
    """
    vanna_api_key = os.environ.get("SQLTRANSLATOR_API_KEY", None)
