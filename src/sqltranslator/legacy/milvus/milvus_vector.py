...
class Milvus_VectorStore(VannaBase):
    ...
    def _create_collections(self):
        self._create_sql_collection("sqltranslatorsql")
        self._create_ddl_collection("sqltranslatorddl")
        self._create_doc_collection("sqltranslatordoc")
    ...
    def _create_sql_collection(self, name: str):
        if not self.milvus_client.has_collection(collection_name=name):
            sqltranslatorsql_schema = MilvusClient.create_schema(
                auto_id=False,
                enable_dynamic_field=False,
            )
            sqltranslatorsql_schema.add_field(
                field_name="id",
            ...
            sqltranslatorsql_index_params = self.milvus_client.prepare_index_params()
            sqltranslatorsql_index_params.add_index(
                field_name="vector",
                index_name="vector",
            ...
            self.milvus_client.create_collection(
                ...
                schema=sqltranslatorsql_schema,
                index_params=sqltranslatorsql_index_params,
                consistency_level="Strong",
            )

    def _create_ddl_collection(self, name: str):
        if not self.milvus_client.has_collection(collection_name=name):
            sqltranslatorddl_schema = MilvusClient.create_schema(
                auto_id=False,
                enable_dynamic_field=False,
            )
            sqltranslatorddl_schema.add_field(
                field_name="id",
                datatype=DataType.VARCHAR,
                max_length=65535,
                is_primary=True,
            ...
            sqltranslatorddl_index_params = self.milvus_client.prepare_index_params()
            sqltranslatorddl_index_params.add_index(
                field_name="vector",
                index_name="vector",
                index_type="AUTOINDEX",
                metric_type="L2",
            ...
            self.milvus_client.create_collection(
                collection_name=name,
                schema=sqltranslatorddl_schema,
                index_params=sqltranslatorddl_index_params,
                consistency_level="Strong",
            )

    def _create_doc_collection(self, name: str):
        if not self.milvus_client.has_collection(collection_name=name):
            sqltranslatordoc_schema = MilvusClient.create_schema(
                auto_id=False,
                enable_dynamic_field=False,
            )
            sqltranslatordoc_schema.add_field(
                field_name="id",
                datatype=DataType.VARCHAR,
                max_length=65535,
                is_primary=True,
            ...
            sqltranslatordoc_index_params = self.milvus_client.prepare_index_params()
            sqltranslatordoc_index_params.add_index(
                field_name="vector",
                index_name="vector",
                index_type="AUTOINDEX",
                metric_type="L2",
            ...
            self.milvus_client.create_collection(
                collection_name=name,
                schema=sqltranslatordoc_schema,
                index_params=sqltranslatordoc_index_params,
                consistency_level="Strong",
            )
    ...
    def add_question_sql(self, question: str, sql: str, **kwargs) -> str:
        ...
        self.milvus_client.insert(
            collection_name="sqltranslatorsql",
    ...
    def add_ddl(self, ddl: str, **kwargs) -> str:
        ...
        self.milvus_client.insert(
            collection_name="sqltranslatorddl",
    ...
    def add_documentation(self, documentation: str, **kwargs) -> str:
        ...
        self.milvus_client.insert(
            collection_name="sqltranslatordoc",
    ...
    def remove_training_data(self, id: str, **kwargs) -> bool:
        if id.endswith("-sql"):
            self.milvus_client.delete(collection_name="sqltranslatorsql", ids=[id])
            return True
        elif id.endswith("-ddl"):
            self.milvus_client.delete(collection_name="sqltranslatorddl", ids=[id])
            return True
        elif id.endswith("-doc"):
            self.milvus_client.delete(collection_name="sqltranslatordoc", ids=[id])
            return True
        else:
            return False
