"""
Legacy VannaBase adapter for the SQLTranslator framework.
...
class LegacyVannaAdapter(ToolRegistry, AgentMemory):
    ...
    registry with configurable group-based access control. This allows legacy SQLTranslator
    ...
    Example:
        ```python
        from sqltranslator.legacy.base import VannaBase
        from sqltranslator.legacy.adapter import LegacyVannaAdapter

        # Initialize your legacy SQLTranslator instance
    ...
    def __init__(
        ...
        Args:
            legacy_vn: The legacy VannaBase instance to wrap
