"""
Flask route implementations for SQLTranslator.
"""
...
def register_chat_routes(
    ...
    @app.route("/api/sqltranslator/v2/chat_sse", methods=["POST"])
    ...
    @app.route("/api/sqltranslator/v2/chat_websocket")
    ...
    @app.route("/api/sqltranslator/v2/chat_poll", methods=["POST"])
