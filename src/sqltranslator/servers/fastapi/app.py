"""
FastAPI server factory for SQLTranslator.
"""
...
class SQLTranslatorFastAPIServer:
    """FastAPI server factory for SQLTranslator."""
    ...
    def create_app(self) -> FastAPI:
        ...
        app = FastAPI(
            title="SQLTranslator API",
            description="API server for SQLTranslator framework",
            version="0.1.0",
            **app_config,
        )
        ...
        async def health_check() -> Dict[str, str]:
            return {"status": "healthy", "service": "sqltranslator"}
