"""
CLI for running SQLTranslator servers with example agents.
"""
...
def main(
    ...
    """Run SQLTranslator server with optional example agent."""
    ...
    if example:
        ...
        try:
            ...
            llm_service = MockLlmService(
                response_content="Hello! I'm a SQLTranslator demo server. How can I help you?"
            )
    ...
    from ..flask.app import SQLTranslatorFlaskServer
    from ..fastapi.app import SQLTranslatorFastAPIServer

    # Create and run server
    server: Union[SQLTranslatorFlaskServer, SQLTranslatorFastAPIServer]
    if framework == "flask":
        server = SQLTranslatorFlaskServer(agent, config=server_config)
        ...
        server = SQLTranslatorFastAPIServer(agent, config=server_config)
