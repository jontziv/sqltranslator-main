...
@customElement('sqltranslator-chat')
export class SQLTranslatorChat extends LitElement {
  static styles = [
    vannaDesignTokens,
    css`
      *, *::before, *::after {
  ...
  @property() title = 'SQLTranslator Chat';
  ...
  private ensureApiClient() {
    ...
    console.log('[SQLTranslatorChat] Creating API client with:', {
