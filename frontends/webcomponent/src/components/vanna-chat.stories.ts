...
import './sqltranslator-chat';
import './sqltranslator-message';
import './plotly-chart';

const meta: Meta = {
  title: 'Components/SQLTranslatorChat',
  component: 'sqltranslator-chat',
  parameters: {
    layout: 'fullscreen',
    backgrounds: {
      default: 'light',
...
export const WithConversation: Story = {
  ...
  render: (args) => {
    setTimeout(() => {
      const chat = document.querySelector('sqltranslator-chat') as any;
...
export const MaxAutonomyMode: Story = {
  args: {
    title: 'SQLTranslator Agent - Max Autonomy',
...
export const WithRichComponents: Story = {
  args: {
    title: 'SQLTranslator Agent - Rich Components',
...
export const WithToolExecutionComponents: Story = {
  args: {
    title: 'SQLTranslator Agent - Tool Execution',
...
export const WithChart: Story = {
  args: {
    title: 'SQLTranslator Agent - Chart Display',
...
export const WithButtons: Story = {
  args: {
    title: 'SQLTranslator Agent - Button Components',
