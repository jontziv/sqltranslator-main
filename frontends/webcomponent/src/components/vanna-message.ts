...
@customElement('sqltranslator-message')
export class SQLTranslatorMessage extends LitElement {
  static styles = [
    vannaDesignTokens,
    css`
      :host {
      ...
      .message {
        ...
        border-radius: var(--sqltranslator-chat-bubble-radius);
      ...
      .message.assistant {
        ...
        border-radius: var(--sqltranslator-chat-bubble-radius) var(--sqltranslator-chat-bubble-radius) var(--sqltranslator-chat-bubble-radius) var(--vanna-space-2);
      }
      ...
      .message.user {
        ...
        border-radius: var(--sqltranslator-chat-bubble-radius) var(--sqltranslator-chat-bubble-radius) var(--vanna-space-2) var(--sqltranslator-chat-bubble-radius);
