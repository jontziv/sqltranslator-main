...
// SQLTranslator design tokens - Data-First Agents branding
export const vannaDesignTokens = css`
  :host {
    /* SQLTranslator Brand Colors */
    ...
    --sqltranslator-chat-bubble-radius: 18px;
    --sqltranslator-chat-bubble-radius-sm: 12px;
    --sqltranslator-chat-spacing: 16px;
    --sqltranslator-chat-avatar-size: 40px;
  }
